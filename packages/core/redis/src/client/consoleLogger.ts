...
export const CONSOLE_LOGGER: ILogger = {
  debug: (message: string, context?: LogContext) => console.debug(message, context ?? ""),
  info: (message: string, context?: LogContext) => console.info(message, context ?? ""),
  waiting: (message: string, context?: LogContext) => console.info(message, context ?? ""),
  progress: (message: string, context?: LogContext) => console.info(message, context ?? ""),
  cached: (message: string, context?: LogContext) => console.info(message, context ?? ""),
  success: (message: string, context?: LogContext) => console.info(message, context ?? ""),
  ...
  fatal: (message: string, error?: unknown, context?: LogContext) =>
    console.error(message, error ?? "", context ?? ""),
  skip: (message: string, context?: LogContext) => console.info(message, context ?? ""),

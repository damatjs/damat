...
console.log("✅ Default schema:", migration1.upStatements[0].includes('"public"."user"') ? "public" : "unknown");

// Test 2: Custom schema in module
const module2 = toModuleSchema("app2", [UserSchema], { schema: "custom_schema" });
const migration2 = generateMigration.generateFromSnapshot(module2);
console.log("✅ Custom schema:", migration2.upStatements[0].includes('"custom_schema"."user"') ? "custom_schema" : "failed");

  ...
  return (
    <div className="forge relative overflow-hidden rounded-xl border border-line bg-canvas shadow-xl shadow-black/10">
      ...
      <div className="flex items-center justify-between border-b border-line px-5 py-3">
        <span className="font-mono text-xs text-faint">your agent, over MCP</span>
      ...
      <div className="space-y-4 p-5 text-sm">
        ...
        <div className="space-y-2 font-mono text-code">
          <p className="text-code-dim">
            ⚙ add_module {'{'} source: <span className="text-code-str">&quot;damatjs/user&quot;</span>{' '}
            {'}'}
          </p>
          <p className="text-code-ok">✓ registered &quot;user&quot; in damat.config.ts</p>
        ...
        <p className="max-w-[85%] rounded-lg border border-line bg-surface px-4 py-2.5 text-muted">
          Done — run <code className="font-mono text-ink">bun damat-orm migrate:up</code> to apply
          the 4 new tables.
        </p>
      </div>
      <div className="border-t border-line px-5 py-3.5">
        <Link
          href={`${DOCS_PATH}/installing-modules-with-ai`}

  ...
  const tabs = [
    {
      id: "model",
      label: "Model",
      filename: "src/modules/user/models/user.ts",
      html: modelHtml,
      code: MODEL_SAMPLE,
    },
    {
      id: "service",
      label: "Service",
      filename: "src/modules/user/service.ts",
      html: serviceHtml,
      code: SERVICE_SAMPLE,
    },
    {
      id: "route",
      label: "Route",
      filename: "src/api/routes/users/[userId]/route.ts",
      html: routeHtml,
      code: ROUTE_SAMPLE,
    },
    {
      id: "workflow",
      label: "Workflow",
      filename: "src/modules/user/workflows/onboarding.ts",
      html: workflowHtml,
      code: WORKFLOW_SAMPLE,
    },
  ];

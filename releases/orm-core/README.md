# @damatjs/orm-core — release notes

Change history for this package. For how it works **now**, read the
[package README](../../packages/orm/core/README.md) and its
[docs](../../packages/orm/core/docs/).
...
| 0.1.0   | First published minor release — the `ModelRegistry` + `QueryLogger` runtime layer, stabilized; relation-resolution fix; unit-test suite         | [0.1.0 →](./0.1.0.md) |

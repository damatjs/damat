# @damatjs/orm-connector — release notes

Change history for this package. For how it works **now**, read the
[package README](../../packages/orm/connector/README.md) and its
[docs](../../packages/orm/connector/docs/).

| Version      | Summary                                                                                                                                               | Upgrade notes               |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| 1.0.0-beta.0 | Aggregate active pool stats and physical-connection-only logging                                                                                      | [next →](./1.0.0-beta.0.md) |
...
| 0.1.0        | First published minor release — the standalone connection/pool manager (`ConnectionManager`, pool tools, config presets)                              | [0.1.0 →](./0.1.0.md)       |

...
export const newOrganizationsSchema = z
  .object({
    name: z.string(),
    slug: z.string(),
  })
...
export type UpdateOrganizationsInput = z.infer<
  typeof updateOrganizationsSchema
>;
...
export const OrganizationsParamsSchema = z
  .object({
    id: z.string(),
  })
  .strict();

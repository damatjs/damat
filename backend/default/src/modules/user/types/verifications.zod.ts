...
export const newVerificationsSchema = z
  .object({
    identifier: z.string(),
    value: z.string(),
...
export const updateVerificationsSchema = z
  .object({
...
export type UpdateVerificationsInput = z.infer<
  typeof updateVerificationsSchema
>;

export const VerificationsQuerySchema = z
  .object({
...
export const VerificationsParamsSchema = z
  .object({
    id: z.string(),
  })
  .strict();
